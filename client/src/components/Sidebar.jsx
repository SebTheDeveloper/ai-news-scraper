export default function Sidebar({ isTldr, setIsTldr, isFavorites, setIsFavorites }) {
  ...
  return(
    <div className='sidebar'>
        ...
        <ul>
          ...
          <li onClick={handlePageChange} style={{ fontWeight: isTldr ? "bold" : "normal"}}>Daily TLDR</li>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <li onClick={handlePageChange} style={{ fontWeight: isFavorites ? "bold" : "normal"}}>Favorites</li>
