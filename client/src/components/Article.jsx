...
export default function Article({ item: { _id, title, createdOn, source, summary, categories, link } }) {
  ...
  return (
    <div className='article'>
      ...
      <div className="ask-question">
        ...
        <div className="answer" id={isLoading ? "researching" : "answer"}>{isLoading ? 'researching...' : answer}</div>
      </div>
